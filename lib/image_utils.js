...
/**
 * Crops the original image data according to given dimensions and stores it in a category
 */
...
/**
 * Generates the cropped images for various image categories 
 */
...
/**
 * Calls functions in series to load the image data from file, crops it, uploads the generated images to imgur
	...
	async.waterfall([
		...
		function deleteFiles(fileNames, links, callback) {
			async.each(fileNames, function deleteFile(fileName, cb) {
				//Delere the temporary file created
